...
export class ScTab {
  ...
  readonly class = computed(() =>
    cn(
      ...
      "group-data-[orientation=vertical]:w-full group-data-[orientation=vertical]:justify-start",
      ...
      "group-data-[orientation=horizontal]:after:inset-x-0 group-data-[orientation=horizontal]:after:bottom-[-5px] group-data-[orientation=horizontal]:after:h-0.5",
      "group-data-[orientation=vertical]:after:inset-y-0 group-data-[orientation=vertical]:after:-right-1 group-data-[orientation=vertical]:after:w-0.5",
